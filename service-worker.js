const CACHE_NAME = 'cache-v25'; // Use a static or manually managed version
const RESOURCES_TO_PRECACHE = [
    'estilos/normalize.css?v25',
    'estilos/styles.css?v25',
    'estilos/mediaQueries.css?v25',
    'javascript/script.js?v25',
